...
class SearchProblem:
    """ A SearchProblem implements a search problem and specifies an initial state, a goal state, a successor function, a goal test predicate, and a heuristic function"""    
